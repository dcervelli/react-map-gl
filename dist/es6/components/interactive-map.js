...
export default class InteractiveMap extends PureComponent {
  ...
  constructor(props) {
    ...
    _defineProperty(this, "_onMouseMove", event => {
    ...
    _defineProperty(this, "_onMouseClick", event => {
    ...
    _defineProperty(this, "_onContextMenu", event => {
      if (this.props.onContextMenu) {
        this.props.onContextMenu(event);
      }
    });

    _defineProperty(this, "_eventCanvasLoaded", ref => {
      // This will be called with `null` after unmount, releasing event manager resource
      this._eventManager.setElement(ref);
    });

    _defineProperty(this, "_staticMapLoaded", ref => {
      this._map = ref;
    });
  ...
  componentDidMount() {
    const eventManager = this._eventManager; // Register additional event handlers for click and hover
